const setContextPad = (lf: any) => {
    ...
    // lf.extension.contextPad.setContextMenuByType("conditionNode", [
    //     userConfig,
    //     serviceConfig,
    // ]);
    // lf.extension.contextPad.setContextMenuByType("rectNode", [
    //     userConfig,
    //     serviceConfig,
    //     endConfig
    // ]);
    // lf.extension.contextPad.setContextMenuByType("endNode", [
    //     userConfig,
    //     serviceConfig
    // ]);
};
